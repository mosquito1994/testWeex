...
module.exports = function (dir) {
  ...
  const webConfig = webpackMerge(_webConfig, {
    entry: [_webConfig.entry.index, `webpack-hot-middleware/client?reload=true&path=/${dir}/__webpack_hmr`],
    plugins: _webConfig.plugins.concat(plugins)
  });

  const weexConfig = new commonConfig(dir)[1];
